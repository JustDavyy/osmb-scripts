...
public class XPTracking {
    ...
    public XPTracking(ScriptCore core) {
        ...
        SearchableImage woodcuttingFull = new SearchableImage(SPRITE_WOODCUTTING_ID, core, new SingleThresholdComparator(15), ColorModel.RGB);
        this.woodcuttingSprite = woodcuttingFull.subImage(woodcuttingFull.width / 2, 0, woodcuttingFull.width / 2, woodcuttingFull.height);
    }
    ...
    private Integer getXpCounter() {
        ...
        boolean matcheswoodcutting = core.getImageAnalyzer().findLocation(bounds, woodcuttingSprite) != null;
        if (!matcheswoodcutting) {
            return null;
        }
