    ...
    private void checkForUpdates() {
        ...
        if (compareVersions(scriptVersion, latest) < 0) {
            ...
            try {
                ...
                File[] old = dir.listFiles((d, n) -> n.equals("dHarambeHunter.jar") || n.startsWith("dHarambeHunter-"));
                if (old != null) for (File f : old) if (f.delete()) log("UPDATE", "🗑 Deleted old: " + f.getName());

                File out = new File(dir, "dHarambeHunter-" + latest + ".jar");
                URL url = new URL("https://raw.githubusercontent.com/JustDavyy/osmb-scripts/main/dHarambeHunter/jar/dHarambeHunter.jar");
