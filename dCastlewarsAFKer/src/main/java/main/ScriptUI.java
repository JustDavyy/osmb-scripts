...
public class ScriptUI {
    ...
    private static final String PREF_WEBHOOK_INTERVAL = "dcastlewarsafker_webhook_interval";
    private static final String PREF_WEBHOOK_INCLUDE_USER = "dcastlewarsafker_webhook_include_user";
    private static final String PREF_WEBHOOK_INCLUDE_STATS = "dcastlewarsafker_webhook_include_stats";
