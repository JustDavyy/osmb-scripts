...
public class XPTracking {
    ...
    private static final int SPRITE_AGILITY_ID = 227;

    private final ScriptCore core;
    private final SearchableImage agilitySprite;
    ...
    public XPTracking(ScriptCore core) {
        ...
        SearchableImage agilityFull = new SearchableImage(SPRITE_AGILITY_ID, core, new SingleThresholdComparator(15), ColorModel.RGB);
        this.agilitySprite = agilityFull.subImage(agilityFull.width / 2, 0, agilityFull.width / 2, agilityFull.height);
    }
    ...
    private Integer getXpCounter() {
        ...
        boolean matchesagility = core.getImageAnalyzer().findLocation(bounds, agilitySprite) != null;
        if (!matchesagility) {
            return null;
        }
