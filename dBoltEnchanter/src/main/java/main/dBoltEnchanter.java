...
public class dBoltEnchanter extends Script {
    ...
    public static int enchantedBoltID;
    public static Set<Integer> requiredRunes;
    public static double xpPerCast;
    public static int requiredMagicLevel;
    ...
    public dBoltEnchanter(Object scriptCore) {
        super(scriptCore);
    ...
    @Override
    public void onStart() {
        log(getClass(), "Starting dBoltEnchanter v" + scriptVersion);

        checkForUpdates();

        ScriptUI ui = new ScriptUI(this);
        Scene scene = ui.buildScene(this);
        getStageController().show(scene, "dBoltEnchanter Options", false);

        boltID = ui.getSelectedBoltId();
        enchantedBoltID = ui.getSelectedEnchantedBoltId();
        requiredRunes = ui.getRequiredRunes();
        xpPerCast = ui.getXpPerCast();
        requiredMagicLevel = ui.getRequiredMagicLevel();
    ...
    private void checkForUpdates() {
        String latest = getLatestVersion("https://raw.githubusercontent.com/JustDavyy/osmb-scripts/main/dBoltEnchanter/src/main/java/main/dBoltEnchanter.java");
        ...
        if (compareVersions(scriptVersion, latest) < 0) {
            ...
            try {
                ...
                File[] old = dir.listFiles((d, n) -> n.equals("dBoltEnchanter.jar") || n.startsWith("dBoltEnchanter-"));
                if (old != null) {
                    for (File f : old) {
                ...
                File out = new File(dir, "dBoltEnchanter-" + latest + ".jar");
                URL url = new URL("https://raw.githubusercontent.com/JustDavyy/osmb-scripts/main/dBoltEnchanter/jar/dBoltEnchanter.jar");
